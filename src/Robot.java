...
public class Robot extends IterativeRobot {
	...
	super.disabledInit(); // Calls the Iterative Robot disabledInit() because there is no point in us writing one
    }
	...
	*/
	...
	if (joystickOp.getRawButton(6) && button6 == false) { // Setpoints are integers (not doubles)
	    setpoint += scale * 1000;
	    button6 = true;
	...
	SmartDashboard.putNumber("Hammer Encoder Distance", hammerEncoder.getDistance());
